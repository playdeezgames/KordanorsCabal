...
Friend Class GroundInventoryProcessor
    ...
    Public Overrides Sub Initialize()
        ...
        currentItemIndex = 0
        groundItems = Game.World.PlayerCharacter(WorldData).Movement.Location.Inventory.Items.ToList
    End Sub
    ...
    Private Function PickUpItem() As UIState
        Game.World.PlayerCharacter(WorldData).Items.Inventory.Add(groundItems(currentItemIndex))
        groundItems = Game.World.PlayerCharacter(WorldData).Movement.Location.Inventory.Items.ToList
