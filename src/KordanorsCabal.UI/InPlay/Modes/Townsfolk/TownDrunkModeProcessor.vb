Friend Class TownDrunkModeProcessor
    ...
    Private Function GiveBeer(player As Character) As UIState
        player.EnqueueMessage($"You give {ItemType.Beer.Name} to {New FeatureType(TownDrunk).Name}.", $"{New FeatureType(TownDrunk).Name} drinks it all in one swallow, burps, and hands you {ItemType.Bottle.Name}.")
