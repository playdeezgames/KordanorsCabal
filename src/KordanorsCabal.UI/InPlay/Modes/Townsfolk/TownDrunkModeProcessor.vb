Friend Class TownDrunkModeProcessor
    ...
    Private Function GiveBeer(player As Character) As UIState
        player.EnqueueMessage($"You give {ItemType.Beer.Name} to {OldFeatureType.TownDrunk.ToNew.Name}.", $"{OldFeatureType.TownDrunk.ToNew.Name} drinks it all in one swallow, burps, and hands you {ItemType.Bottle.Name}.")
