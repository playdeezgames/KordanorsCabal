    ...
    Friend Overrides Function HandleButton(player As ICharacter, button As Button) As UIState
        Select Case button.Index
            ...
            Case OffersButtonIndex
                ShoppeProcessor(Of String).ShoppeType = ShoppeType.FromId(StaticWorldData.World, Game.OldShoppeType.BlackMage)
                Return UIState.ShoppeOffers
            Case SellButtonIndex
                ShoppeProcessor(Of Item).ShoppeType = ShoppeType.FromId(StaticWorldData.World, Game.OldShoppeType.BlackMage)
                Return UIState.ShoppeSell
            Case PricesButtonIndex
                ShoppeProcessor(Of String).ShoppeType = ShoppeType.FromId(StaticWorldData.World, Game.OldShoppeType.BlackMage)
                Return UIState.ShoppePrices
            Case BuyButtonIndex
                ShoppeProcessor(Of (Long, Long)).ShoppeType = ShoppeType.FromId(StaticWorldData.World, Game.OldShoppeType.BlackMage)
