...
Friend Class SpellListProcessor
    ...
    Public Overrides Sub Initialize()
        ...
        currentItemIndex = 0
        items = World.FromWorldData(WorldData).PlayerCharacter.Spellbook.Spells.Select(Function(x) (x.Key, x.Value)).ToList
    End Sub
    ...
    Private Function CastSpell() As UIState
        World.FromWorldData(WorldData).PlayerCharacter.Spellbook.Cast(Game.SpellType.FromId(WorldData, items(currentItemIndex).Item1))
