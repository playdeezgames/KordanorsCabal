...
Module ItemTypeUIDescriptorUtility
    Friend ReadOnly ItemTypeUIDescriptors As IReadOnlyDictionary(Of Long, ItemTypeUIDescriptor) =
        New Dictionary(Of Long, ItemTypeUIDescriptor) From
        {
            ...
            {OldItemType.Food, New ItemTypeUIDescriptor(Pattern.F, (5, 15), Hue.Orange)},
            ...
            {OldItemType.Mushroom, New ItemTypeUIDescriptor(Pattern.Spade, (3, 17), Hue.Orange)},
            ...
            {OldItemType.ShoeLaces, New ItemTypeUIDescriptor(Pattern.S, (11, 15), Hue.Orange)},
            ...
            {OldItemType.SpaceSord, New ItemTypeUIDescriptor(Pattern.LeftArrow, (19, 17), Hue.Purple)},
