Public Class CharacterEquipSlotDataTests
    Private Shared Sub WithCharacterEquipSlotData(stuffToDo As Action(Of Mock(Of IStore), ICharacterEquipSlotData))
    ...
    Public Sub ShouldClearOutDataForAnItem()
        WithCharacterEquipSlotData(
            Sub(store, subject)
                ...
                store.Verify(Sub(x) x.ClearForColumnValue(It.IsAny(Of Action), Tables.CharacterEquipSlots, (Columns.ItemId, itemId)), Times.Once)
            End Sub)
    End Sub
    <Fact>
