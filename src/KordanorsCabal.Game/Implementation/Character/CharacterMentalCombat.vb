Public Class CharacterMentalCombat
    ...
    Function RollInfluence() As Long Implements ICharacterMentalCombat.RollInfluence
        Return RollDice(If(Character.Statistics.GetStatistic(CharacterStatisticType.FromId(WorldData, CharacterStatisticType3)), 0) + NegativeInfluence())
    End Function
    Function RollWillpower() As Long Implements ICharacterMentalCombat.RollWillpower
        Return RollDice(If(Character.Statistics.GetStatistic(CharacterStatisticType.FromId(WorldData, CharacterStatisticType4)), 0) + NegativeInfluence())
    End Function
    ReadOnly Property IsDemoralized() As Boolean Implements ICharacterMentalCombat.IsDemoralized
        Get
            If Character.Statistics.GetStatistic(CharacterStatisticType.FromId(WorldData, CharacterStatisticType4)).HasValue Then
                Return CurrentMP <= 0
            End If
            Return False
        End Get
    ...
    Sub AddStress(delta As Long) Implements ICharacterMentalCombat.AddStress
        Character.Statistics.ChangeStatistic(CharacterStatisticType.FromId(WorldData, CharacterStatisticType13), delta)
    End Sub
    ReadOnly Property CanIntimidate As Boolean Implements ICharacterMentalCombat.CanIntimidate
        Get
            If Not Character.Statistics.GetStatistic(CharacterStatisticType.FromId(WorldData, CharacterStatisticType4)).HasValue Then
                Return False
            End If
    ...
    Property CurrentMP As Long Implements ICharacterMentalCombat.CurrentMP
        Get
            Return Math.Max(0, Character.Statistics.GetStatistic(CharacterStatisticType.FromId(WorldData, CharacterStatisticType7)).Value - Character.Statistics.GetStatistic(CharacterStatisticType.FromId(WorldData, CharacterStatisticType13)).Value)
        End Get
        Set(value As Long)
            Character.Statistics.SetStatistic(CharacterStatisticType.FromId(WorldData, CharacterStatisticType13), Character.Statistics.GetStatistic(CharacterStatisticType.FromId(WorldData, CharacterStatisticType7)).Value - value)
        End Set
    End Property
    ReadOnly Property CanDoIntimidation() As Boolean Implements ICharacterMentalCombat.CanDoIntimidation
        Get
            If If(Character.Statistics.GetStatistic(CharacterStatisticType.FromId(WorldData, CharacterStatisticType3)), 0) <= 0 Then
                Return False
            End If
