Public Class Durability
    ...
    ReadOnly Property Current As Long? Implements IDurability.Current
        Get
            If Maximum.HasValue Then
                Return Maximum.Value - GetStatistic(ItemStatisticType.FromId(WorldData, ItemStatisticType28))
            End If
            Return Nothing
        End Get
    End Property
    ...
    Public Sub Reduce(amount As Long) Implements IDurability.Reduce
        If Maximum.HasValue Then
            ChangeStatistic(ItemStatisticType.FromId(WorldData, ItemStatisticType28), amount)
        End If
    End Sub
