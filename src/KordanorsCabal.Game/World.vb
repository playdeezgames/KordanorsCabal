Public Module StaticWorld
    ...
    Private Sub CreateMoon(worldData As IWorldData)
        ...
        For row As Long = 0 To MoonRows - 1
            For column As Long = 0 To MoonColumns - 1
                ...
                dungeonLocation.Statistics.SetStatistic(LocationStatisticType.FromId(worldData, LocationStatisticType1), column)
                dungeonLocation.Statistics.SetStatistic(LocationStatisticType.FromId(worldData, LocationStatisticType2), row)
    ...
    Private Sub SecondRoll(worldData As IWorldData)
        Dim dice = PlayerCharacter(worldData).Statistics.GetStatistic(CharacterStatisticType.FromId(worldData, CharacterStatisticType9))
        PlayerCharacter(worldData).Statistics.SetStatistic(CharacterStatisticType.FromId(worldData, CharacterStatisticType9), 0)
        While dice > 0
    ...
    Public ReadOnly Property PlayerCharacter(worldData As IWorldData) As IPlayerCharacter
        Get
