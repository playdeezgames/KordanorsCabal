...
Public Module ItemTypeDescriptorUtility
    Friend ReadOnly ItemTypeDescriptors As IReadOnlyDictionary(Of ItemType, ItemTypeDescriptor) =
        New Dictionary(Of ItemType, ItemTypeDescriptor) From
        {
            ...
            {ItemType.GoblinEar, New TrophyDescriptor("Goblin Ear", 5, New List(Of ShoppeType) From {ShoppeType.BlackMage})},
            ...
            {ItemType.MembershipCard, New TrophyDescriptor("Membership Card", 10, New List(Of ShoppeType))},
            {ItemType.MoonPortal, New MoonPortalDescriptor},
            {ItemType.Mushroom, New TrophyDescriptor("Mushroom", 25, New List(Of ShoppeType) From {ShoppeType.BlackMage})},
            ...
            {ItemType.RatTail, New TrophyDescriptor("Rat Tail", 1, New List(Of ShoppeType) From {ShoppeType.BlackMage})},
            ...
            {ItemType.ShoeLaces, New TrophyDescriptor("Shoe Laces", 0, New List(Of ShoppeType))},
            {ItemType.Shortsword, New ShortswordDescriptor},
            {ItemType.SkullFragment, New TrophyDescriptor("Skull Fragment", 5, New List(Of ShoppeType) From {ShoppeType.BlackMage})},
            {ItemType.SnakeFang, New TrophyDescriptor("Snake Fang", 3, New List(Of ShoppeType) From {ShoppeType.BlackMage})},
            ...
            {ItemType.ZombieTaint, New TrophyDescriptor("Zombie Taint", 5, New List(Of ShoppeType) From {ShoppeType.BlackMage})}
        }
