    ...
    Sub New()
        MyBase.New(
            ...
            Sub(character)
                ...
                character.EnqueueMessage($"You use yer {ItemType.Bong.Name} to smoke yer {ItemType.Herb.Name}.", $"You gain {delta} {CharacterStatisticType.FromId(StaticWorldData.World, Mana).Name}.")
            End Sub)
    End Sub
End Class
