Friend Class AirShardDescriptor
    ...
    Sub New()
        MyBase.New(
            ...
            "Air Shard",,
            MakeDictionary(
                (1L, MakeHashSet(LocationType.FromId(DungeonBoss)))),
            MakeDictionary(
                (1L, "1d1")),,,,,, ,
            False,,,,,,,,
            ...
            Sub(character)
                ...
                Dim locations = Location.FromLocationType(LocationType.FromId(Dungeon)).Where(Function(x) x.DungeonLevel.Id = level.Id)
