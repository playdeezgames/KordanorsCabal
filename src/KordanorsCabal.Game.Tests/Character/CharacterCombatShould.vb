    ...
    Sub roll_defend()
        WithSubject(
            Sub(worldData, id, subject)
                ...
                worldData.Verify(Function(x) x.StatisticType.ReadDefaultValue(2))
                worldData.Verify(Function(x) x.StatisticType.ReadDefaultValue(11))
    ...
    Sub do_damage()
        WithSubject(
            Sub(worldData, id, subject)
                ...
                worldData.Verify(Function(x) x.StatisticType.ReadDefaultValue(12))
                worldData.Verify(Function(x) x.Player.Read())
            End Sub)
    End Sub
    <Fact>
    ...
    Sub determine_damage()
        WithSubject(
            Sub(worldData, id, subject)
                ...
                worldData.Verify(Function(x) x.StatisticType.ReadDefaultValue(10))
                worldData.Verify(Function(x) x.Player.Read())
            End Sub)
    End Sub
    <Fact>
