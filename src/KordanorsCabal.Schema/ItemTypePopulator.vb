Friend Module ItemTypePopulator
    ...
    Friend Sub PopulateItemTypes(connection As SqliteConnection)
        ...
        PopulateItemTypesRecord(connection, ItemType24, "koettbulle", 1)
        ...
        PopulateItemTypesRecord(connection, ItemType35, "koettbulle", 1)
    ...
    Sub PopulateItemTypeEventsRecord(connection As SqliteConnection, ItemTypeId As Long, EventId As Long, EventName As String)
        ...
        End Using
    End Sub
    Friend Const EventType1 = 1
    Friend Const EventType2 = 2
    Friend Const EventType3 = 3
    Friend Const EventType4 = 4
    Sub PopulateItemTypeEvents(connection As SqliteConnection)
        PopulateItemTypeEventsRecord(connection, ItemType7, EventType2, "AlwaysTrue")
        PopulateItemTypeEventsRecord(connection, ItemType7, EventType3, "DrinkPotion")
        PopulateItemTypeEventsRecord(connection, ItemType11, EventType2, "CanUseEarthShard")
        PopulateItemTypeEventsRecord(connection, ItemType11, EventType3, "UseEarthShard")
        PopulateItemTypeEventsRecord(connection, ItemType12, EventType2, "CanUseWaterShard")
        PopulateItemTypeEventsRecord(connection, ItemType12, EventType3, "UseWaterShard")
        PopulateItemTypeEventsRecord(connection, ItemType13, EventType2, "CanUseFireShard")
        PopulateItemTypeEventsRecord(connection, ItemType13, EventType3, "UseFireShard")
        PopulateItemTypeEventsRecord(connection, ItemType14, EventType2, "CanUseAirShard")
        PopulateItemTypeEventsRecord(connection, ItemType14, EventType3, "UseAirShard")
        PopulateItemTypeEventsRecord(connection, ItemType22, EventType2, "IsFightingUndead")
        PopulateItemTypeEventsRecord(connection, ItemType22, EventType3, "UseHolyWater")
        PopulateItemTypeEventsRecord(connection, ItemType23, EventType2, "IsInDungeon")
        PopulateItemTypeEventsRecord(connection, ItemType23, EventType3, "UseTownPortal")
        PopulateItemTypeEventsRecord(connection, ItemType24, EventType2, "AlwaysTrue")
        PopulateItemTypeEventsRecord(connection, ItemType24, EventType3, "EatFood")
        PopulateItemTypeEventsRecord(connection, ItemType25, EventType2, "AlwaysTrue")
        PopulateItemTypeEventsRecord(connection, ItemType25, EventType3, "UseMagicEgg")
        PopulateItemTypeEventsRecord(connection, ItemType26, EventType2, "CanUseBeer")
        PopulateItemTypeEventsRecord(connection, ItemType26, EventType3, "UseBeer")
        PopulateItemTypeEventsRecord(connection, ItemType28, EventType2, "CanUsePr0n")
        PopulateItemTypeEventsRecord(connection, ItemType28, EventType3, "UsePr0n")
        PopulateItemTypeEventsRecord(connection, ItemType29, EventType2, "IsInDungeon")
        PopulateItemTypeEventsRecord(connection, ItemType29, EventType3, "UseMoonPortal")
        PopulateItemTypeEventsRecord(connection, ItemType30, EventType2, "CanUseBottle")
        PopulateItemTypeEventsRecord(connection, ItemType30, EventType3, "UseBottle")
        PopulateItemTypeEventsRecord(connection, ItemType31, EventType2, "CanLearnHolyBolt")
        PopulateItemTypeEventsRecord(connection, ItemType31, EventType3, "LearnHolyBolt")
        PopulateItemTypeEventsRecord(connection, ItemType34, EventType2, "HasBong")
        PopulateItemTypeEventsRecord(connection, ItemType34, EventType3, "UseHerb")
        PopulateItemTypeEventsRecord(connection, ItemType35, EventType1, "PurifyFood")
        PopulateItemTypeEventsRecord(connection, ItemType35, EventType2, "AlwaysTrue")
        PopulateItemTypeEventsRecord(connection, ItemType35, EventType3, "UseRottenFood")
        PopulateItemTypeEventsRecord(connection, ItemType37, EventType2, "CanUseRottenEgg")
        PopulateItemTypeEventsRecord(connection, ItemType37, EventType3, "UseRottenEgg")
        PopulateItemTypeEventsRecord(connection, ItemType47, EventType2, "CanLearnPurify")
        PopulateItemTypeEventsRecord(connection, ItemType47, EventType3, "LearnPurify")
        PopulateItemTypeEventsRecord(connection, ItemType24, EventType4, "FoodDecay")
        PopulateItemTypeEventsRecord(connection, ItemType35, EventType4, "RottenFoodDecay")
    End Sub
End Module
