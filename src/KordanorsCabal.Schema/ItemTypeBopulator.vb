Friend Module ItemTypeBopulator
    ...
    Sub PopulateItemTypeShopTypes(connection As SqliteConnection)
        PopulateItemTypeShopTypesRecord(connection, ItemType7, ShoppeType4, 2)
        PopulateItemTypeShopTypesRecord(connection, ItemType8, ShoppeType1, 1)
        PopulateItemTypeShopTypesRecord(connection, ItemType9, ShoppeType1, 1)
        PopulateItemTypeShopTypesRecord(connection, ItemType10, ShoppeType2, 1)
        PopulateItemTypeShopTypesRecord(connection, ItemType10, ShoppeType2, 2)
        PopulateItemTypeShopTypesRecord(connection, ItemType10, ShoppeType2, 3)
        PopulateItemTypeShopTypesRecord(connection, ItemType15, ShoppeType2, 1)
        PopulateItemTypeShopTypesRecord(connection, ItemType15, ShoppeType2, 2)
        PopulateItemTypeShopTypesRecord(connection, ItemType15, ShoppeType2, 3)
        PopulateItemTypeShopTypesRecord(connection, ItemType16, ShoppeType2, 1)
        PopulateItemTypeShopTypesRecord(connection, ItemType16, ShoppeType2, 2)
        PopulateItemTypeShopTypesRecord(connection, ItemType16, ShoppeType2, 3)
        PopulateItemTypeShopTypesRecord(connection, ItemType17, ShoppeType2, 1)
        PopulateItemTypeShopTypesRecord(connection, ItemType17, ShoppeType2, 2)
        PopulateItemTypeShopTypesRecord(connection, ItemType17, ShoppeType2, 3)
        PopulateItemTypeShopTypesRecord(connection, ItemType18, ShoppeType2, 1)
        PopulateItemTypeShopTypesRecord(connection, ItemType18, ShoppeType2, 2)
        PopulateItemTypeShopTypesRecord(connection, ItemType18, ShoppeType2, 3)
        PopulateItemTypeShopTypesRecord(connection, ItemType19, ShoppeType2, 1)
        PopulateItemTypeShopTypesRecord(connection, ItemType19, ShoppeType2, 2)
        PopulateItemTypeShopTypesRecord(connection, ItemType29, ShoppeType2, 3)
        PopulateItemTypeShopTypesRecord(connection, ItemType20, ShoppeType2, 1)
        PopulateItemTypeShopTypesRecord(connection, ItemType20, ShoppeType2, 2)
        PopulateItemTypeShopTypesRecord(connection, ItemType20, ShoppeType2, 3)
        PopulateItemTypeShopTypesRecord(connection, ItemType21, ShoppeType1, 1)
        PopulateItemTypeShopTypesRecord(connection, ItemType22, ShoppeType4, 2)
        PopulateItemTypeShopTypesRecord(connection, ItemType23, ShoppeType1, 2)
        PopulateItemTypeShopTypesRecord(connection, ItemType24, ShoppeType3, 2)
        PopulateItemTypeShopTypesRecord(connection, ItemType25, ShoppeType1, 1)
        PopulateItemTypeShopTypesRecord(connection, ItemType26, ShoppeType3, 2)
        PopulateItemTypeShopTypesRecord(connection, ItemType27, ShoppeType5, 2)
        PopulateItemTypeShopTypesRecord(connection, ItemType28, ShoppeType5, 2)
        PopulateItemTypeShopTypesRecord(connection, ItemType29, ShoppeType1, 2)
        PopulateItemTypeShopTypesRecord(connection, ItemType31, ShoppeType1, 2)
        PopulateItemTypeShopTypesRecord(connection, ItemType33, ShoppeType1, 2)
        PopulateItemTypeShopTypesRecord(connection, ItemType34, ShoppeType1, 2)
        PopulateItemTypeShopTypesRecord(connection, ItemType36, ShoppeType1, 1)
        PopulateItemTypeShopTypesRecord(connection, ItemType38, ShoppeType1, 1)
        PopulateItemTypeShopTypesRecord(connection, ItemType39, ShoppeType5, 2)
        PopulateItemTypeShopTypesRecord(connection, ItemType40, ShoppeType1, 1)
        PopulateItemTypeShopTypesRecord(connection, ItemType41, ShoppeType1, 1)
        PopulateItemTypeShopTypesRecord(connection, ItemType47, ShoppeType1, 2)
        PopulateItemTypeShopTypesRecord(connection, ItemType52, ShoppeType5, 2)
    End Sub
End Module
